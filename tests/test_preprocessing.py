...
def test_notch_attenuates_60hz(preprocessor):
    ...
    filtered = preprocessor.filter(epoch)
...
def test_bandpass_passes_10hz(preprocessor):
...
def test_bandpass_blocks_1hz(preprocessor):
...
def test_bandpass_blocks_80hz(preprocessor):
...
def test_car_sums_to_zero(preprocessor):
